...
//
//
////    public static void update(String[] number,int current){
////        int value=set[current];
////        for(int j=0;j<number.length;j++){
////            if(number[j].equals("0")){
////                break;
////            }
////            for(int i=0;i<n;i++){
////                if(set[Integer.valueOf(number[j])]==current||set[Integer.valueOf(number[j])]!=Integer.valueOf(number[j])){
////                    set[Integer.valueOf(number[j])]=value;
////                }
////            }
////        }
////
